...
#ifndef __SPDM_XCENA_TRANSPORT_LIB_H__
#define __SPDM_XCENA_TRANSPORT_LIB_H__
 ...
 */
spdm_version_number_t spdm_xcena_get_secured_spdm_version(spdm_version_number_t secured_message_version);
